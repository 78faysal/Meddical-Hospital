...
<footer className=" p-4 bg-blue-300 sm:p-6 dark:bg-gray-800">
    <div className="container mx-auto md:flex md:justify-around">
        <div className="mb-6 md:mb-0">
            <Link to="/home" className="flex items-center">
                <span className="self-center text-2xl font-bold whitespace-nowrap  text-2xl font-bold text-indigo-600">MEDDICAL</span>
            </Link>
            <p className="text-gray-700 md:w-4/5 my-3">Leading the Way in Medical
    ...
    <div className="sm:flex sm:items-center sm:justify-between">
        <span className="text-sm text-gray-500 mx-auto dark:text-gray-400">© 2022 <a target="_blank" href="https://mdfoysal.netlify.app/" className="hover:underline">Mohammad Faysal</a>. All Rights Reserved.
        </span>
